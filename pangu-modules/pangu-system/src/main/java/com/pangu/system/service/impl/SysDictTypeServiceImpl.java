...
import com.pangu.system.api.domain.SysDictType;
import com.pangu.system.mapper.SysDictDataMapper;
import com.pangu.system.mapper.SysDictTypeMapper;
...
public class SysDictTypeServiceImpl implements ISysDictTypeService {
    ...
    public void loadingDictCache() {
        List<SysDictData> dictDataList = dictDataMapper.selectList( new LambdaQueryWrapper<SysDictData>().eq(SysDictData::getStatus, UserConstants.DICT_NORMAL));
