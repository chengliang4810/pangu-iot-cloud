      ...
      <el-col :sm="24" :lg="12" style="padding-left: 20px">
        ...
        <p>
          <el-button
            ...
            icon="el-icon-cloudy"
            plain
            @click="goTarget('https://gitee.com/dromara/pangu-cloud-plus')"
            >访问码云</el-button
          >
          <el-button
            size="mini"
            icon="el-icon-s-home"
            plain
            @click="goTarget('https://github.com/dromara/pangu-cloud-plus')"
            >访问主页</el-button
          >
          <el-button
            type="primary"
            ...
            icon="el-icon-cloudy"
            plain
            @click="goTarget('https://gitee.com/dromara/pangu-cloud-plus/wikis/pages?sort_id=5303316&doc_id=2056143')"
          >更新日志</el-button
          >
        </p>
      </el-col>
          ...
          <div class="body">
            <p>
              <i class="el-icon-s-promotion"></i> 官网：<el-link
                href="https://gitee.com/dromara/pangu-cloud-plus"
                target="_blank"
                >https://gitee.com/dromara/pangu-cloud-plus</el-link
              >
            </p>
          </div>
        </el-card>
