package com.pangu.iot.manager.service.impl;
...
import com.pangu.iot.manager.mapper.ProductMapper;
...
public class ProductServiceImpl implements IProductService {
    ...
    private LambdaQueryWrapper<Product> buildQueryWrapper(ProductBO bo) {
        ...
        LambdaQueryWrapper<Product> lqw = Wrappers.lambdaQuery();
                    lqw.eq(StringUtils.isNotBlank(bo.getGroupId()), Product::getGroupId, bo.getGroupId());
