...
import com.pangu.common.emqx.core.MqttCallback;
...
public class EmqxConfig {
    ...
    @Bean
    public MqttClient getClient(MqttConnectOptions options, ApplicationContext applicationContext, EmqProperties emqProperties) throws Exception {
        // 构建Client 设置客户端ID
