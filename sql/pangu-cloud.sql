...
values ('4', 'PLUS官网', '0', '4', 'https://gitee.com/JavaLionLi/PanGu-Cloud-Plus', null, '', 0, 0, 'M', '0', '0', '',
        'guide', 'admin', sysdate(), '', null, '若依官网地址');
-- 二级菜单
insert into sys_menu
...
insert into sys_menu
values ('110', 'XxlJob控制台', '2', '2', 'http://localhost:9900', '', '', 0, 0, 'C', '0', '0', 'monitor:job:list',
        'job', 'admin', sysdate(), '', null, '定时任务菜单');
insert into sys_menu
...
-- oss相关按钮
insert into sys_menu
values ('1600', '文件查询', '118', '1', '#', '', '', 1, 0, 'F', '0', '0', 'system:oss:query', '#', 'admin', sysdate(),
        '', null, '');
insert into sys_menu
values ('1601', '文件上传', '118', '2', '#', '', '', 1, 0, 'F', '0', '0', 'system:oss:upload', '#', 'admin', sysdate(),
        '', null, '');
insert into sys_menu
values ('1602', '文件下载', '118', '3', '#', '', '', 1, 0, 'F', '0', '0', 'system:oss:download', '#', 'admin',
        sysdate(), '', null, '');
insert into sys_menu
values ('1603', '文件删除', '118', '4', '#', '', '', 1, 0, 'F', '0', '0', 'system:oss:remove', '#', 'admin', sysdate(),
        '', null, '');
insert into sys_menu
values ('1604', '配置添加', '118', '5', '#', '', '', 1, 0, 'F', '0', '0', 'system:oss:add', '#', 'admin', sysdate(), '',
        null, '');
insert into sys_menu
values ('1605', '配置编辑', '118', '6', '#', '', '', 1, 0, 'F', '0', '0', 'system:oss:edit', '#', 'admin', sysdate(),
        '', null, '');
...
insert into sys_config
values (11, 'OSS预览列表资源开关', 'sys.oss.previewListResource', 'true', 'Y', 'admin', sysdate(), '', null,
        'true:开启, false:关闭');
...
values (1, 'minio', 'pangu', 'pangu123', 'pangu', '', '127.0.0.1:9000', '', 'N', '', '1', '0', '', 'admin', sysdate(),
        'admin', sysdate(), NULL);
insert into sys_oss_config
values (2, 'qiniu', 'XXXXXXXXXXXXXXX', 'XXXXXXXXXXXXXXX', 'pangu', '', 's3-cn-north-1.qiniucs.com', '', 'N', '', '1',
        '1', '', 'admin', sysdate(), 'admin', sysdate(), NULL);
insert into sys_oss_config
...
values (4, 'qcloud', 'XXXXXXXXXXXXXXX', 'XXXXXXXXXXXXXXX', 'pangu-1250000000', '', 'cos.ap-beijing.myqcloud.com', '',
        'N', 'ap-beijing', '1', '1', '', 'admin', sysdate(), 'admin', sysdate(), NULL);
insert into sys_oss_config
